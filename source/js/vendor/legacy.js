(() => {
			...
			for (let n = 1; n < e.length; n += 1) {
					...
					if (null != r && ((i = r), !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
							...
							for (let s = 0, i = e.length; s < i; s += 1) {
									...
									void 0 !== n && n.enumerable && (C(t[i]) && C(r[i]) ? (r[i].__swiper__ ? (t[i] = r[i]) : T(t[i], r[i])) : !C(t[i]) && C(r[i]) ? ((t[i] = {}), r[i].__swiper__ ? (t[i] = r[i]) : T(t[i], r[i])) : (t[i] = r[i]));
							}
					}
			}
			var i;
	...
	const O = {
			...
			updateSlides: function () {
									...
									c[n] && (c[n].swiperSlideSize = y),
											...
											i.centeredSlides
													? ((C = C + y / 2 + T / 2 + b),
														...
														h.push(C))
													: (i.roundLengths && (C = Math.floor(C)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && u.push(C), h.push(C), (C = C + y + b)),
											(e.virtualSize += y + b),
											(T = y),
											(E += 1);
							}
					...
					if ((Object.assign(e, { slides: c, snapGrid: u, slidesGrid: h, slidesSizesGrid: f }), i.centeredSlides && i.cssMode && !i.centeredSlidesBounds)) {
							S(e.wrapperEl, "--swiper-centered-offset-before", -u[0] + "px"), S(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
	...
	const z = {
			slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
					...
					let w;
					if ((a !== (c || 0) && s && r.emit("beforeSlideChangeStart"), r.updateProgress(v), (w = a > p ? "next" : a < p ? "prev" : "reset"), (u && -v === r.translate) || (!u && v === r.translate)))
			...
			slidePrev: function (e = this.params.speed, t = !0, s) {
					...
					if (
							(void 0 !== h &&
									((f = l.indexOf(h)), f < 0 && (f = i.activeIndex - 1), "auto" === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && ((f = f - i.slidesPerViewDynamic("previous", !0) + 1), (f = Math.max(f, 0)))),
	...
	function D(e) {
			...
			if (!s.allowTouchMove) return g(d.target).is(i.focusableElements) || (s.allowClick = !1), void (i.isTouched && (Object.assign(r, { startX: p, startY: u, currentX: p, currentY: u }), (i.touchStartTime = w())));
			...
			if (c > i.longSwipesMs) {
					...
					t.navigation && (o.target === t.navigation.nextEl || o.target === t.navigation.prevEl)
							? o.target === t.navigation.nextEl
									? t.slideTo(u + b)
									: t.slideTo(u)
							: ("next" === t.swipeDirection && t.slideTo(null !== f ? f : u + b), "prev" === t.swipeDirection && t.slideTo(null !== m ? m : u));
			}
	}
	function N() {
			const e = this,
	...
	const X = {
			setBreakpoint: function () {
					...
					d && !c
							...
							: !d &&
								c &&
								(r.addClass(`${n.containerModifierClass}grid`), ((o.grid.fill && "column" === o.grid.fill) || (!o.grid.fill && "column" === n.grid.fill)) && r.addClass(`${n.containerModifierClass}grid-column`), e.emitContainerClasses()),
			...
			return function (s = {}) {
					...
					"object" == typeof n && null !== n
							? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = { auto: !0 }),
								i in e && "enabled" in n ? (!0 === e[i] && (e[i] = { enabled: !0 }), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = { enabled: !1 }), T(t, s)) : T(t, s))
							: T(t, s);
			};
	}
	const J = {
	...
	class Z {
			constructor(...e) {
					let t, s;
					if ((1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? (s = e[0]) : ([t, s] = e), s || (s = {}), (s = T({}, s)), t && !s.el && (s.el = t), s.el && g(s.el).length > 1)) {
							const e = [];
							return (
									g(s.el).each((t) => {
											const i = T({}, s, { el: t });
	...
	function ne({ swiper: e, extendParams: t, on: s, emit: i }) {
			...
			function d() {
					...
					if (
							...
							if (
									(s.dynamicBullets &&
											...
											s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((a += c - (e.previousIndex - e.loopedSlides || 0)), a > s.dynamicMainBullets - 1 ? (a = s.dynamicMainBullets - 1) : a < 0 && (a = 0)),
											(n = Math.max(c - a, 0)),
					...
					if (("fraction" === s.type && (d.find(ie(s.currentClass)).text(s.formatFractionCurrent(c + 1)), d.find(ie(s.totalClass)).text(s.formatFractionTotal(p))), "progressbar" === s.type)) {
							...
							let n = 1,
									r = 1;
							"horizontal" === t ? (n = i) : (r = i), d.find(ie(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(e.params.speed);
					}
			...
			re(),
					document.querySelector(".projects__slider") &&
							new ee(".projects__slider", {
									...
									speed: 800,
									loop: !0,
									navigation: { nextEl: ".projects__arrow_next", prevEl: ".projects__arrow_prev" },
									breakpoints: {
											320: { slidesPerView: 1.1, spaceBetween: 20, autoHeight: !0 },
											476: { slidesPerView: 1.5, spaceBetween: 20 },
											576: { slidesPerView: 2, spaceBetween: 20 },
											992: { slidesPerView: 2.7, spaceBetween: 20 },
											1268: { slidesPerView: 3.1, spaceBetween: 30 },
									},
									on: {},
							}),
					document.querySelector(".blog__slider") &&
							new ee(".blog__slider", {
									...
									speed: 800,
									loop: !0,
									navigation: { nextEl: ".about__more .more__item_next", prevEl: ".about__more .more__item_prev" },
									breakpoints: {
											320: { slidesPerView: 1.1, spaceBetween: 18, autoHeight: !0 },
											575: { slidesPerView: 1.8, spaceBetween: 30 },
					...
					document.querySelector(".stages__slider") &&
							new ee(".stages__slider", { modules: [se, ne], observer: !0, observeParents: !0, slidesPerView: 1, spaceBetween: 30, autoHeight: !0, speed: 800, loop: !0, navigation: { nextEl: ".stages__slider-arrow_next" }, on: {} });
	});
	let ae = !1;
	setTimeout(() => {
			if (ae) {
